...
@javax.annotation.Generated(
    ...
    comments = "Source: ComputeService.proto")
...
public final class ComputeServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<ComputeServiceOuterClass.ComputeRequest,
      ComputeServiceOuterClass.ComputeResult> getComputeMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Compute",
      requestType = ComputeServiceOuterClass.ComputeRequest.class,
      responseType = ComputeServiceOuterClass.ComputeResult.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<ComputeServiceOuterClass.ComputeRequest,
      ComputeServiceOuterClass.ComputeResult> getComputeMethod() {
    io.grpc.MethodDescriptor<ComputeServiceOuterClass.ComputeRequest, ComputeServiceOuterClass.ComputeResult> getComputeMethod;
      ...
      synchronized (ComputeServiceGrpc.class) {
        if ((getComputeMethod = ComputeServiceGrpc.getComputeMethod) == null) {
          ComputeServiceGrpc.getComputeMethod = getComputeMethod =
              io.grpc.MethodDescriptor.<ComputeServiceOuterClass.ComputeRequest, ComputeServiceOuterClass.ComputeResult>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Compute"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ComputeServiceOuterClass.ComputeRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ComputeServiceOuterClass.ComputeResult.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void compute(ComputeServiceOuterClass.ComputeRequest request,
        io.grpc.stub.StreamObserver<ComputeServiceOuterClass.ComputeResult> responseObserver) {
  ...
  public static final class ComputeServiceBlockingStub
    ...
    /**
     */
    public ComputeServiceOuterClass.ComputeResult compute(ComputeServiceOuterClass.ComputeRequest request) {
  ...
  public static final class ComputeServiceFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<ComputeServiceOuterClass.ComputeResult> compute(
        ComputeServiceOuterClass.ComputeRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_COMPUTE:
          serviceImpl.compute((ComputeServiceOuterClass.ComputeRequest) request,
              (io.grpc.stub.StreamObserver<ComputeServiceOuterClass.ComputeResult>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              ComputeServiceOuterClass.ComputeRequest,
              ComputeServiceOuterClass.ComputeResult>(
  ...
  private static abstract class ComputeServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return ComputeServiceOuterClass.getDescriptor();
    }
